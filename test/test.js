...
describe("JamoProtocol", function () {
  ...
  describe("Protocol operations", function () {
    ...
    it("should allow the trader deposit collateral", async () => {
      ...
      expect((+userPosition[3].toString()) / etherConstant).to.be.equal((+contractDetails[3].toString() / etherConstant))
      ...
      expect((+userPosition[2].toString()) / etherConstant).to.be.greaterThan(0);
    ...
    it("should allow a user increase their position", async () => {
      ...
      expect(+shortPositionAfterIncrease[1].toString() / etherConstant).to.be.greaterThan(+shortPositionBeforeIncrease[1].toString() / etherConstant)
    ...
    it("shoul be able to withraw deposit with intrest", async () => {
      ...
      console.log("asset of vault => ", +valAssetBalance.toString()/ etherConstant);
      console.log("shares of liquidity person => ", +sharesLiquidityMan.toString()/ etherConstant);
